...
<div id="wrapper">
    ...
    <div class="inner-header-area page-header topbar-show with-banner">
                ...
                <li><a href="index.html">Home</a><i class="fa-solid fa-angle-right"></i></li><li class="active">Recent Memories</li>
            </ul>                                    </div> --}}
                    </div>
                </div>
            </div>
                    ...
                    <div class="elementor-element elementor-element-dd9da0f e-flex e-con-boxed e-con e-parent" data-id="dd9da0f" data-element_type="container">
                        <div class="e-con-inner">
            <div class="elementor-element elementor-element-a45163f e-grid e-con-boxed e-con e-child" data-id="a45163f" data-element_type="container">
                        <div class="e-con-inner">
                    <div class="elementor-element elementor-element-7fa4f6a elementor-widget elementor-widget-nexus-events" data-id="7fa4f6a" data-element_type="widget" data-widget_type="nexus-events.default">
                    <div class="elementor-widget-container">
                                                <div class="case-inenr-section">
                    <div class="row">
                                                <div class="col-lg-4 col-md-6">
                            <div class="work-single-boxarea case-box">
                                <div class="img1 image-anime">
                                    <img decoding="async" src="wp-content/uploads/2025/07/gallery-img8.png" alt="Board Meeting">
                                    <div class="plus1">
                                        <a href="index2058.html?tribe_events=board-meeting-2"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                <div class="content-area">
                                    <p>August 2025</p>
                                    <a href="index2058.html?tribe_events=board-meeting-2">Board Meeting</a>
                                    <div class="plus">
                                        <a href="index2058.html?tribe_events=board-meeting-2"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="work-single-boxarea case-box">
                                <div class="img1 image-anime">
                                    <img decoding="async" src="wp-content/uploads/2025/07/gallery-img10.png" alt="Celebration Party">
                                    <div class="plus1">
                                        <a href="indexc5fc.html?tribe_events=celebration-party"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                <div class="content-area">
                                    <p>August 2025</p>
                                    <a href="indexc5fc.html?tribe_events=celebration-party">Celebration Party</a>
                                    <div class="plus">
                                        <a href="indexc5fc.html?tribe_events=celebration-party"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="work-single-boxarea case-box">
                                <div class="img1 image-anime">
                                    <img decoding="async" src="wp-content/uploads/2025/07/hero-img4-Copy.png" alt="Kitten Day">
                                    <div class="plus1">
                                        <a href="index30b9.html?tribe_events=kitten-day"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                <div class="content-area">
                                    <p>July 2025</p>
                                    <a href="index30b9.html?tribe_events=kitten-day">Kitten Day</a>
                                    <div class="plus">
                                        <a href="index30b9.html?tribe_events=kitten-day"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="work-single-boxarea case-box">
                                <div class="img1 image-anime">
                                    <img decoding="async" src="wp-content/uploads/2025/07/gallery-img7.png" alt="Board Meeting">
                                    <div class="plus1">
                                        <a href="index084e.html?tribe_events=board-meeting"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                <div class="content-area">
                                    <p>June 2025</p>
                                    <a href="index084e.html?tribe_events=board-meeting">Board Meeting</a>
                                    <div class="plus">
                                        <a href="index084e.html?tribe_events=board-meeting"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="work-single-boxarea case-box">
                                <div class="img1 image-anime">
                                    <img decoding="async" src="wp-content/uploads/2025/07/gallery-img11.png" alt="Kitten Adoption Day">
                                    <div class="plus1">
                                        <a href="indexe4c8.html?tribe_events=kitten-adoption-day"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                <div class="content-area">
                                    <p>June 2025</p>
                                    <a href="indexe4c8.html?tribe_events=kitten-adoption-day">Kitten Adoption Day</a>
                                    <div class="plus">
                                        <a href="indexe4c8.html?tribe_events=kitten-adoption-day"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="work-single-boxarea case-box">
                                <div class="img1 image-anime">
                                    <img decoding="async" src="wp-content/uploads/2025/07/gallery-img9.png" alt="Birthday Party">
                                    <div class="plus1">
                                        <a href="indexd4b4.html?tribe_events=birthday-party"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                <div class="content-area">
                                    <p>June 2025</p>
                                    <a href="indexd4b4.html?tribe_events=birthday-party">Birthday Party</a>
                                    <div class="plus">
                                        <a href="indexd4b4.html?tribe_events=birthday-party"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
...
<link rel='stylesheet' id='elementor-post-3721-css' href='wp-content/uploads/elementor/css/post-37219620.css?ver=1756675370' type='text/css' media='all' />
...
<link rel="https://api.w.org/" href="index52f0.json?rest_route=/" /><link rel="alternate" title="JSON" type="application/json" href="index53e4.json?rest_route=/wp/v2/pages/3721" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="xmlrpc0db0.php?rsd" />
<meta name="generator" content="WordPress 6.8.2" />
<link rel="canonical" href="indexbdd3.html?page_id=3721" />
<link rel='shortlink' href='indexe582.html?p=3721' />
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="indexa87e.php?rest_route=%2Foembed%2F1.0%2Fembed&amp;url=https%3A%2F%2Fjthemes.net%2Fthemes%2Fwp%2Fnexus%2F%3Fpage_id%3D3721" />
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="index80d5.php?rest_route=%2Foembed%2F1.0%2Fembed&amp;url=https%3A%2F%2Fjthemes.net%2Fthemes%2Fwp%2Fnexus%2F%3Fpage_id%3D3721&amp;format=xml" />
