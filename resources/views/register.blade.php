...
<div class="inner-header-area page-header topbar-show with-banner">
            ...
            <li><a href="index.html">Home</a><i class="fa-solid fa-angle-right"></i></li><li class="active">Register</li>
        </ul>                                    </div>
                </div>
            </div>
        </div> --}}
    ...
    {{-- the code that give it extra space  --}}
	...
	<div class="login-section-area login_template">
        ...
        <div class="row">
            <div class="col-lg-6 m-auto login-box">
				<div class="wp-block-frontend-login-with-gutenberg-blocks-register-form"><form name="flr-blocks-register-form" id="flr-blocks-register-form" method="post">
            <div class="flr-blocks-form-row">
               <div class="flr-blocks-input-group"><label class="flr-blocks-input-label" style="color:; font-weight:bold" for="flr-blocks-username-for-register">
						        Username
						     </label><input class="flr-blocks-input-control" id="flr-blocks-username-for-register" name="flr-blocks-username-for-register" type="text" required style=border-radius:px placeholder="" /></div></div><div class="flr-blocks-form-row">
               <div class="flr-blocks-input-group"><label class="flr-blocks-input-label" style="color:; font-weight:bold" for="flr-blocks-email-for-register">
								Your e-mail
							 </label><input class="flr-blocks-input-control" id="flr-blocks-email-for-register" name="flr-blocks-email-for-register" type="text" required style=border-radius:px placeholder="" /></div></div><div class="flr-blocks-form-row">
	            <div class="flr-blocks-input-group"><label class="flr-blocks-input-label" style="color:; font-weight:bold" for="flr-blocks-password-for-register">
								Password
							  </label><input class="flr-blocks-input-control" id="flr-blocks-password-for-register" name="flr-blocks-password-for-register" type="password" required style=border-radius:px placeholder="" /></div></div><div class="flr-blocks-form-row">
	            <div class="flr-blocks-input-group"><label class="flr-blocks-input-label" style="color:; font-weight:bold" for="flr-blocks-password-again-for-register">
							    Password Again
							 </label><input class="flr-blocks-input-control" id="flr-blocks-password-again-for-register" name="flr-blocks-password-again-for-register" type="password" required style=border-radius:px placeholder="" /></div></div><div class="flr-blocks-form-row">
				<div class="flr-blocks-input-group">
					<input id="flr-blocks-terms-and-privacy" checked="checked" type="checkbox" name="flr-blocks-terms-and-privacy" required class="flr-blocks-form-check-input"/>
						...
						I have read and accept <a href="#" target="_blank">terms and conditions</a> and <a href="#" target="_blank">privacy policy</a>
						</label>
					</div>
				</div><input type="hidden" name="action" value="flrblocksregisterhandle"><input type="hidden" name="security" value="eef744b0d6"><div class="flr-blocks-form-row">
						<button style="color:; background-color: ; border-color: #000;border-style: solid;border-width: 0px;border-radius: px;font-weight: " type="submit" id="flr-blocks-register-submit" class="flr-blocks-register-btn flr-blocks-btn wp-block-button__link wp-element-button">
							Register
						</button>
					</div>
					<div id="flr-blocks-register-loading" class="flr-blocks-loading flr-blocks-hide">Loading&#8230;</div></form>
			<div id="flr-blocks-register-form-result"></div><div style="text-align:center;">
						Already signed up? 
						<a style="text-decoration:none;" href="{{url('/lonig')}}">
						    Login
						</a>
					 </div>
    </div>
...
/* <![CDATA[ */
window.flr_blocks_ajax_object = {"ajax_url":"https:\/\/jthemes.net\/themes\/wp\/nexus\/wp-admin\/admin-ajax.php","nonce":"1f23d8a3e8","strings":{"loading":"Loading...","error":"An error occurred","success":"Success!"}}
/* ]]> */
</script>
<link rel="https://api.w.org/" href="index52f0.json?rest_route=/" /><link rel="alternate" title="JSON" type="application/json" href="index5ae6.json?rest_route=/wp/v2/pages/4279" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="xmlrpc0db0.php?rsd" />
<meta name="generator" content="WordPress 6.8.2" />
<link rel="canonical" href="index4753.html?page_id=4279" />
<link rel='shortlink' href='index4ea9.html?p=4279' />
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="indexdbb6.json?rest_route=%2Foembed%2F1.0%2Fembed&amp;url=https%3A%2F%2Fjthemes.net%2Fthemes%2Fwp%2Fnexus%2F%3Fpage_id%3D4279" />
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="index1865.php?rest_route=%2Foembed%2F1.0%2Fembed&amp;url=https%3A%2F%2Fjthemes.net%2Fthemes%2Fwp%2Fnexus%2F%3Fpage_id%3D4279&amp;format=xml" />
