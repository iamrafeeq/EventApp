...
<div id="wrapper">
    ...
    {{-- <div class="inner-header-area page-header topbar-show with-banner">
                ...
                <li><a href="index.html">Home</a><i class="fa-solid fa-angle-right"></i></li><li class="active">Login</li>
            </ul>                                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class="login-section-area login_template">
            ...
            <div class="row">
                <div class="col-lg-6 m-auto login-box">
                    <div class="wp-block-frontend-login-with-gutenberg-blocks-login-form">
                    <form name="flr-blocks-login-form" id="flr-blocks-login-form" method="post"><div class="flr-blocks-form-row">
                                <div class="flr-blocks-input-group"><label class="flr-blocks-input-label" style="color:; font-weight:bold" for="flr-blocks-username-or-email">Username or E-mail</label><input class="flr-blocks-input-control" id="flr-blocks-username-or-email" name="flr-blocks-username-or-email" type="text" required style=border-radius:px placeholder="" /></div></div><div class="flr-blocks-form-row">
                                            <div class="flr-blocks-input-group"><label class="flr-blocks-input-label" style="color:; font-weight:bold" for="flr-blocks-password">Password</label><input class="flr-blocks-input-control" id="flr-blocks-password" name="flr-blocks-password" type="password" required style=border-radius:px placeholder="" /></div></div><div class="flr-blocks-form-row">
                            <div class="flr-blocks-form-check-group">
                                ...
                                <label class="flr-blocks-form-check-label" for="flr-blocks-rememberme">Remember me</label>
                            </div>
                        </div><input type="hidden" name="action" value="flrblocksloginhandle"><input type="hidden" name="security" value="56761a756e"><div class="flr-blocks-form-row">
                            <button style="color:; background-color: ; border-color: #000;border-style: solid;border-width: 0px;border-radius: px;font-weight: " type="submit" id="flr-blocks-login-submit" class="flr-blocks-login-btn flr-blocks-btn wp-block-button__link wp-element-button">
                                Login
                            </button>
                            
                        </div>
                        <div id="flr-blocks-login-loading" class="flr-blocks-loading flr-blocks-hide">Loading&#8230;</div></form><div id="flr-blocks-login-form-result"></div><div style="text-align:center;">
                    <a style="text-decoration:none;" href="{{url('/forgetpssword')}}">
                            Lost Password
                    </a> | <a style="text-decoration:none;" href="{{url('/register')}}">
                            Register
                    </a>
                </div>
        </div>			</div>
    ...
    {{-- here is the map and  and lets get start box i going to commnt this  --}}
